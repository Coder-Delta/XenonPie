...
def rank_job(job: dict, user_profile: dict) -> dict:
    ...
    # Education match
    user_edu = user_profile.get("education_level", "graduate")
    job_edu = job.get("education_level", "graduate")
    ...
    # State match
    preferred_states = user_profile.get("states", ["all_india"])
    job_state = job.get("state_tag", "all_india")
